void main(){
    ...
    if(animation == openborconstant("ANI_ATTACK1") || animation == openborconstant("ANI_SPECIAL") || animation == openborconstant("ANI_FREESPECIAL3") || animation == openborconstant("ANI_CHARGEATTACK") || animation == openborconstant("ANI_ATTACKUP") || animation == openborconstant("ANI_ATTACKDOWN")){
        float speed = 1.7;
